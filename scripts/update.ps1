...
# 2. Update all dependencies to the latest version (including pre-commit hooks).
# 3. Install the package in editable mode with dev dependencies.
# 4. Install pre-commit hooks.
# 5. Export the dependencies to requirements.txt.
...
try {
    ...
    Write-Output "# This file is automatically generated by ``dev.ps1 update``. Do not edit it manually." > requirements.txt
